...
use Mageguru\Customrequest\Model\Uploader;

class Customrequest extends Column
{
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                $item[$fieldName . '_link'] = $this->urlBuilder->getUrl(
                    'mobileapi/mobilebanner/edit',
                    ['mobilebanner_id' => $item['mobilebanner_id']]
                );
