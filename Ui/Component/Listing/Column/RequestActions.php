...
namespace Mageguru\Customrequest\Ui\Component\Listing\Column;

class RequestActions extends \Magento\Ui\Component\Listing\Columns\Column
{

    const URL_PATH_DELETE = 'mageguru_customrequest/request/delete';
    protected $urlBuilder;
    const URL_PATH_EDIT = 'mageguru_customrequest/request/edit';
    const URL_PATH_DETAILS = 'mageguru_customrequest/request/details';
