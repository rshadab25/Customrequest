...
namespace Mageguru\Customrequest\Controller\Adminhtml\Request;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Mageguru\Customrequest\Model\Request::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            $this->dataPersistor->set('mageguru_customrequest_request', $data);
